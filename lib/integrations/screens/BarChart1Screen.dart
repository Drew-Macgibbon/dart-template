    ...
    return BarChartData(
      barTouchData: BarTouchData(
        ...
        touchCallback: (FlTouchEvent event, BarTouchResponse? response) {
          setState(() {
            if (response?.spot != null && response?.spot is! PointerUpEvent && response?.spot is! PointerExitEvent) {
              ...
              switch (value.toInt()) {
                case 0:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('M'));
                case 1:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('T'));
                case 2:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('W'));
                case 3:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('T'));
                case 4:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('F'));
                case 5:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('S'));
                case 6:
                  return SideTitleWidget(
                      axisSide: meta.axisSide, child: Text('S'));
                default:
