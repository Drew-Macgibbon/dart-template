              ...
              child: PieChart(
                PieChartData(
                  pieTouchData: PieTouchData(
                    ...
                    setState(() {
                      final desiredTouch = pointer.localPosition is! PointerExitEvent && pointer.isInterestedForInteractions is! PointerUpEvent;
                      if (desiredTouch && touch!.touchedSection != null) {
                        touchedIndex = touch.touchedSection!.touchedSectionIndex;
                      } else {
                        touchedIndex = -1;
                      }
                    });
