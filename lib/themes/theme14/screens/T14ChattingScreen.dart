      ...
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            ...
            8.width,
            Text(widget.name!, style: TextStyle(color: Colors.blue, fontSize: 16)),
          ],
        ),
        actions: [Padding(padding: EdgeInsets.only(right: 16), child: Icon(Icons.call, color: Colors.blue , size: 20))],
      ),
      body: Stack(
        children: [
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, index) {
                ...
                // return ChatMessageWidget1(isMe: true, data: data); // EDITED
